package com.law.piks.widget.peekandpop;
...
import com.law.piks.widget.peekandpop.model.HoldAndReleaseView;
import com.law.piks.widget.peekandpop.model.LongHoldView;
...
public class PeekAndPop {
    ...
    protected static final long LONG_CLICK_DURATION = 350;
    ...
    protected void initialisePeekView() {
        ...
        peekLayout = (FrameLayout) inflater.inflate(R.layout.peek_and_pop_background, contentView, false);

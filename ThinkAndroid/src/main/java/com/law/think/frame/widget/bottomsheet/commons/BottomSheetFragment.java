...
/**
 * A fragment that shows itself in a {@link BottomSheetLayout}. Like a
 * {@link android.support.v4.app.DialogFragment}, you can show this either in a
 * bottom sheet by using {@link #show(FragmentManager, int)} or attach it to a
 * view with the normal fragment transaction methods.
 * <p>
 * If you don't want to extend from this for your fragment instance, you can use
 * {@link BottomSheetFragmentDelegate} in your fragment implementation instead.
 * You must, however, still implement {@link BottomSheetFragmentInterface}.
 */

package com.law.think.frame.widget.bottomsheet.commons;
...
import com.law.think.frame.widget.bottomsheet.OnSheetDismissedListener;

/**
 * This class represents a delegate which you can use to extend BottomSheet's
 * fragment support to any {@link Fragment} implementing
 * {@link BottomSheetFragmentInterface}.
 * <p>
 * When using an {@link BottomSheetFragmentDelegate}, you should any methods
 * exposed in it rather than the {@link Fragment} method of the same name. This
 * applies to:
 * <ul>
 ...
 * </ul>
 * There also some Fragment lifecycle methods which should be proxied to the
 * delegate:
 * <ul>
 ...
 * </ul>
 * <p>
 * An {@link Activity} can only be linked with one
 * {@link BottomSheetFragmentDelegate} instance, so the instance returned from
 * {@link #create(BottomSheetFragmentInterface)} should be kept until the
...
public final class BottomSheetFragmentDelegate implements OnSheetDismissedListener {
	...
	/**
	 * DialogFragment-like show() method for displaying this the associated
	 * sheet fragment
	 * 
	 * @param manager
	 *            FragmentManager instance
	 * @param bottomSheetLayoutId
	 *            Resource ID of the {@link BottomSheetLayout}
	 */
	public void show(FragmentManager manager, @IdRes int bottomSheetLayoutId) {
		dismissed = false;
		shownByMe = true;
		this.bottomSheetLayoutId = bottomSheetLayoutId;
		manager.beginTransaction().add(fragment, String.valueOf(bottomSheetLayoutId)).commit();
	}
	 ...
	 * @param bottomSheetLayoutId
	 *            Resource ID of the {@link BottomSheetLayout}
	 * @return the back stack ID of the fragment after the transaction is
	 *         committed.
	 */
	...
	/**
	 * Dismiss the fragment and it's bottom sheet. If the fragment was added to
	 * the back stack, all back stack state up to and including this entry will
	 * be popped. Otherwise, a new transaction will be committed to remove this
	 * fragment.
	 */
	public void dismiss() {
	 ...
	 * {@link FragmentTransaction#commitAllowingStateLoss()}. See linked
	 ...
	 * 
	 * @param context
	 *            Context to match the Fragment API, unused.
	 */
	...
	/**
	 * Retrieves the appropriate layout inflater, either the sheet's or the
	 * view's super container. Note that you should handle the result of this in
	 * your getLayoutInflater method.
	 * 
	 * @param savedInstanceState
	 *            Instance state, here to match Fragment API but unused.
	 * @param superInflater
	 *            The result of the view's inflater, usually the result of
	 ...
	 * 
	 * @param savedInstanceState
	 *            Instance state, here to match the Fragment API but unused
	 */
	 ...
	 * 
	 * @param outState
	 *            The output state, here to match the Fragment API but unused
	 */

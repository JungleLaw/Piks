...
public class AppUtils {
    ...
    public static class AppInfo {
         ...
         */
        public AppInfo(String name, Drawable icon, String packageName, String packagePath, String versionName,
                       int versionCode, boolean isSD, boolean isUser) {
            this.setName(name);
            this.setIcon(icon);
        ...
        public String toString() {
            return "AppInfo [name=" + name + ", icon=" + icon + ", packageName=" + packageName + ", packagePath="
                    + packagePath + ", versionName=" + versionName + ", versionCode=" + versionCode + ", isSD=" + isSD
                    + ", isUser=" + isUser + "]";
        }

package com.law.think.frame.reflect;
...
import com.law.think.frame.reflect.KernelLang.BreakException;
import com.law.think.frame.reflect.KernelLang.CallbackBreak;
...
public abstract class KernelReflect {
	...
	public static List<Method> methods(Class cls) {
		return methods(cls, 0);
	}

	public static List<Method> methods(Class cls, int ancest) {
		return declaredMethods(cls, ancest, false);
	}

	public static List<Method> declaredMethods(Class cls) {
		return declaredMethods(cls, 0);
	}

	public static List<Method> declaredMethods(Class cls, int ancest) {
		return declaredMethods(cls, ancest, true);
	}

	public static List<Method> declaredMethods(Class cls, int ancest, boolean declared) {
	 ...
	 * @return
	 */
	public static Method assignableMethod(Class cls, final String name, int ancest, boolean declared,
			boolean assignable, boolean cacheable, final Class... parameterTypes) {

...
public class InstrumentationIoc extends Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle bundle) {
        ...
        // .d(activity + " 布局设置耗时 View组件，适配器，fragment解析 等耗时 " +
        // (System.currentTimeMillis() - time));
        Logger.i("InstrumentationIoc", activity + " 启动耗时 " + (System.currentTimeMillis() - time));
        //        Logger.i("InstrumentationIoc", "callActivityOnCreate");
    }

    @Override
    public void callActivityOnNewIntent(Activity activity, Intent intent) {
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_ONNEW, intent);
    ...
    public void callActivityOnPause(Activity activity) {
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_PAUSE);
    ...
    public void callActivityOnResume(Activity activity) {
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_RESUME);
    ...
    public void callActivityOnRestart(Activity activity) {
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_RESTART);
    ...
    public void callActivityOnStart(Activity activity) {
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_START);
    ...
    public void callActivityOnStop(Activity activity) {
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_STOP);
    ...
    public void callActivityOnDestroy(Activity activity) {
        ...
        // 记录当前的activity
        // AnalysisManager.analysisProcess(activity,
        // LoonConstant.Number.ACTIVITY_DESTROY);
        super.callActivityOnDestroy(activity);
        //		Logger.i("InstrumentationIoc", "callActivityOnDestroy");
    }
    ...
    public Activity newActivity(ClassLoader cl, String className, Intent intent) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        ...
        // }
        // return (Activity) BeanFactory.instance(clazz, null, new
        // LoonComponentHandler());

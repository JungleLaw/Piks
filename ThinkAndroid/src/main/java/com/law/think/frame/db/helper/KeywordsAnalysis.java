...
public class KeywordsAnalysis {
	private static final String[] KEY_WORDS = new String[] { "", "ABORT", "ACTION", "ADD", "AFTER", "ALTER", "ANALYZE",
			"AND", "AS", "ASC", "ATTACH", "AUTOINCREMENT", "BEFORE", "BEGIN", "BETWEEN", "BY", "CASCADE", "CASE",
			"CAST", "CHECK", "COLLATE", "COLUMN", "COMMIT", "CONFLICT", "CONSTRAINT", "CREATE", "CROSS", "CURRENT_DATE",
	...
	public static boolean isKeyword(String word) {
		if (TextUtils.isEmpty(word))
			return false;
		if (keywords == null) {
			keywords = Arrays.asList(KEY_WORDS);
		}
